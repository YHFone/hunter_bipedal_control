...
#ifndef __low_cmd_t_hpp__
#define __low_cmd_t_hpp__
...
int low_cmd_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int low_cmd_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int low_cmd_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t low_cmd_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* low_cmd_t::getTypeName()
{
    return "low_cmd_t";
}

int low_cmd_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int low_cmd_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int low_cmd_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
